...
export default function SummaryPage() {
  ...
  const buildLocalSummary = () => {
    // Build a local summary from stored data for demo purposes
    ...
    setSummaryData({
      chiefComplaints: ['Data from AI chat session'],
      hpi: 'Summary will be generated by AI based on your conversation.',
